...
export default function PreciosClient({ productos: initialProductos }: PreciosClientProps) {
  ...
  async function deleteTier(precioId: string) {
    if (!confirm('¿Eliminar este rango de volumen?')) return
    try {
  ...
  return (
    <div className="p-4 space-y-6">
      <div>
        <h1 className="text-2xl font-bold tracking-tight">Configuración de Precios</h1>
        <p className="text-sm text-muted-foreground mt-1">Define rangos de volumen y precios por producto</p>
      </div>
