...
export default function ProduccionPage() {
  ...
  const renderStep1 = () => (
    <div className="space-y-4">
      <h2 className="text-xl font-semibold text-gray-800">Stock Inicial del Día</h2>
  ...
  const renderStep2 = () => (
    <div className="space-y-4">
      ...
      <div className="bg-cyan-50 p-4 rounded-lg">
        ...
        <p className="mt-2 text-center text-lg font-semibold text-cyan-600">
          Promedio: {prodHielo}
        </p>
      </div>
  ...
  const renderStep3 = () => (
    <div className="space-y-4">
      <h2 className="text-xl font-semibold text-gray-800">Confirmar Producción</h2>
      ...
      <div className="bg-green-50 p-4 rounded-lg">
        <h3 className="font-semibold text-green-800 mb-3">Producción Calculada</h3>
        <div className="grid grid-cols-2 gap-4">
          <div className="text-center">
            <p className="text-sm text-gray-600">Agua</p>
            <p className="text-2xl font-bold text-green-600">{prodAgua}</p>
          </div>
          <div className="text-center">
            <p className="text-sm text-gray-600">Hielo</p>
            <p className="text-2xl font-bold text-green-600">{prodHielo}</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-purple-50 p-4 rounded-lg">
        <p className="text-center">
          <span className="text-purple-600">Comisión Sellador:</span>
      ...
      <div className="bg-blue-50 p-4 rounded-lg">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="text-center">
            <p className="text-sm text-gray-600">Agua</p>
            <p className="text-2xl font-bold text-blue-600">{stockFinAgua}</p>
          </div>
          <div className="text-center">
            <p className="text-sm text-gray-600">Hielo</p>
            <p className="text-2xl font-bold text-blue-600">{stockFinHielo}</p>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="max-w-md mx-auto p-4">
      <h1 className="text-2xl font-bold text-gray-800 mb-2">Registro de Producción</h1>
      <p className="text-gray-500 mb-6">Control de producción diaria</p>
      {renderStepper()}
      {step === 1 && renderStep1()}
      {step === 2 && renderStep2()}
      {step === 3 && renderStep3()}
