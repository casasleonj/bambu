...
export function ClienteForm({
  ...
  // FIX hydration: no montar el formulario modal cuando está cerrado.
  // Esto reduce la superficie de hydration y evita que TelefonoInput
  // y otros inputs entren en el árbol de React innecesariamente.
        ...
        {activeSection === 'basico' && (
          <div className="space-y-4">
            ...
            <TelefonoInput
              ...
              helpText="Número de WhatsApp o celular. Se agrega automáticamente +57"
              icon={
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
