...
import { z } from 'zod'
import type { Cliente, NuevoRecurrenteForm, CanalRecurrente } from './types'
        ...
        >
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-4">
              {/* G6 (ADR-PEDIDO-ORIGEN-CANAL-001): antes había un 2do
                  ChipGroup "Origen del pedido" (tipo: ENVIO|PUNTO) redundante
                  con este — dos controles independientes y sin sincronizar
                  para el mismo concepto de negocio, que permitían
                  combinaciones contradictorias (p.ej. tipo=PUNTO +
                  canal=DOMICILIO) sin ninguna validación. `canal` es el
                  campo canónico; `tipo` sale del contrato. */}
              <ChipGroup
                label="Entrega"
