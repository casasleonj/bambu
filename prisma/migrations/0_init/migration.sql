...
-- CreateIndex
CREATE INDEX "Cliente_barrio_idx" ON "Cliente"("barrio");

-- CreateIndex
CREATE INDEX "Cliente_frecuencia_idx" ON "Cliente"("frecuencia");

-- CreateIndex
CREATE INDEX "Cliente_proxEntrega_idx" ON "Cliente"("proxEntrega");

-- CreateIndex
CREATE INDEX "Trabajador_createdById_idx" ON "Trabajador"("createdById");

-- CreateIndex
CREATE INDEX "Trabajador_rol_activo_idx" ON "Trabajador"("rol", "activo");

-- CreateIndex
CREATE INDEX "Nomina_createdById_idx" ON "Nomina"("createdById");

-- CreateIndex
CREATE INDEX "Nomina_trabajadorId_idx" ON "Nomina"("trabajadorId");
...
-- CreateIndex
CREATE INDEX "Pedido_embarqueId_idx" ON "Pedido"("embarqueId");
...
-- CreateIndex
CREATE INDEX "Pedido_esRecurrente_idx" ON "Pedido"("esRecurrente");

-- CreateIndex
CREATE INDEX "Pedido_idOrigen_idx" ON "Pedido"("idOrigen");

-- CreateIndex
CREATE INDEX "Pedido_fecha_estado_idx" ON "Pedido"("fecha", "estado");
...
-- CreateIndex
CREATE INDEX "Pedido_embarqueId_estado_idx" ON "Pedido"("embarqueId", "estado");

-- CreateIndex
CREATE INDEX "Pedido_canal_estado_idx" ON "Pedido"("canal", "estado");
...
-- CreateIndex
CREATE INDEX "Embarque_trabajadorId_idx" ON "Embarque"("trabajadorId");

-- CreateIndex
CREATE INDEX "Embarque_rutaId_idx" ON "Embarque"("rutaId");

-- CreateIndex
CREATE INDEX "Embarque_fecha_idx" ON "Embarque"("fecha");

-- CreateIndex
CREATE INDEX "Embarque_estado_idx" ON "Embarque"("estado");
...
-- CreateIndex
CREATE INDEX "Factura_saldo_idx" ON "Factura"("saldo");
...
-- CreateIndex
CREATE INDEX "Abono_facturaId_idx" ON "Abono"("facturaId");

-- CreateIndex
CREATE INDEX "Abono_clienteId_idx" ON "Abono"("clienteId");

-- CreateIndex
CREATE INDEX "Abono_fecha_idx" ON "Abono"("fecha");

-- CreateIndex
CREATE INDEX "Abono_facturaId_fecha_idx" ON "Abono"("facturaId", "fecha");
...
-- CreateIndex
CREATE INDEX "Produccion_trabajadorId_fecha_idx" ON "Produccion"("trabajadorId", "fecha");

-- CreateIndex
CREATE INDEX "Produccion_turno_fecha_idx" ON "Produccion"("turno", "fecha");
...
-- CreateIndex
CREATE INDEX "Gasto_categoria_fecha_idx" ON "Gasto"("categoria", "fecha");
...
-- CreateIndex
CREATE INDEX "CompraInsumo_proveedorId_idx" ON "CompraInsumo"("proveedorId");
...
-- CreateIndex
CREATE INDEX "PrecioVolumen_productoId_canal_activo_idx" ON "PrecioVolumen"("productoId", "canal", "activo");
...
-- CreateIndex
CREATE UNIQUE INDEX "NotaCredito_numero_key" ON "NotaCredito"("numero");

-- CreateIndex
CREATE INDEX "NotaCredito_pedidoId_idx" ON "NotaCredito"("pedidoId");
...
-- CreateIndex
CREATE INDEX "Historial_entidad_idx" ON "Historial"("entidad");
...
-- CreateIndex
CREATE INDEX "Historial_entidad_registroId_idx" ON "Historial"("entidad", "registroId");

-- CreateIndex
CREATE INDEX "Historial_entidad_fecha_idx" ON "Historial"("entidad", "fecha");
...
-- AddForeignKey
ALTER TABLE "NotaCredito" ADD CONSTRAINT "NotaCredito_pedidoId_fkey" FOREIGN KEY ("pedidoId") REFERENCES "Pedido"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
