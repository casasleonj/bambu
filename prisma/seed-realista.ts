...
const TIPOS_NEGOCIO = ['Tienda', 'Restaurante', 'Café', 'Hotel', 'Bar', 'Ferretería', 'Panadería', 'Carnicería', 'Frutería', 'Peluquería', 'Farmacia', 'Papelería', 'Lavandería', 'Taller', 'Consultorio', 'Gimnasio', 'Salón de eventos', 'Guardería', 'Veterinaria', 'Estación de servicio']
    ...
    for (const turno of turnos) {
      ...
      await prisma.produccion.create({
        data: {
          ...
          stockIniAgua,
          stockIniHielo,
          conteoAAgua: randInt(50, 200),
          conteoBAgua: randInt(20, 80),
          conteoAHielo: randInt(30, 120),
          conteoBHielo: randInt(10, 50),
          prodAgua,
          prodHielo,
          ventasAgua,
          ventasHielo,
          stockFinAgua,
          stockFinHielo,
          comSelladorAgua: prodAgua * 50,
          comSelladorHielo: prodHielo * 50,
          comSellTotal: (prodAgua + prodHielo) * 50,
