...
#### FASE 3 — Creación de pedido: captura unificada (1–2 PRs) ⏳ EN CURSO (3a y 3b hechas)
...
- **3c... (pendiente, sesiones futuras)**: extraer el editor de productos (`PedidoItemEditor`, ALS §5) como componente propio — depende de `resolverPrecios` (debounce + fetch), la pieza de mayor riesgo restante. Mismo patrón "lift state up" que 3b.
