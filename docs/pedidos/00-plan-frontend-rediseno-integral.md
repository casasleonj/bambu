...
> **Siguiente:** Composición (`PedidosWorkspace` recompone Fase 3 + reducer + `PedidoProposal`/`PedidoReview`/`PedidoRiskSignals`/`PedidoCommitBar`, consume el endpoint preview).
