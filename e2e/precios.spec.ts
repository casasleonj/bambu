...
test.describe('Precios', () => {
  ...
  test('page loads', async ({ page }) => {
    ...
    await goto(page, '/precios')
    await page.waitForTimeout(1000)
    await expect(page.locator('h1:has-text("Configuración de Precios")')).toBeVisible({ timeout: 10000 })
  ...
  test('agregar rango de volumen', async ({ page }) => {
    ...
    await expect(page.locator('h1:has-text("Configuración de Precios")')).toBeVisible({ timeout: 5000 })
  })
